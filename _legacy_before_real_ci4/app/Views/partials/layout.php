...
<div class="relative">
        ...
        <div class="flex items-center gap-4">
          <div class="relative">
            ...
            <div
              class="absolute right-0 mt-3 hidden z-50 w-56 rounded-2xl border border-white/10 bg-zinc-900/95 bg-surface-container-high p-4 shadow-[0_20px_45px_rgba(0,0,0,0.45)]"
              data-guest-menu
              role="menu"
            >
