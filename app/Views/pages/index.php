...
<html class="dark" lang="es"><head>
      ...
      <div class="space-y-20 pb-20 -mt-[20px] relative z-20">
        ...
        <section class="px-8 md:px-16 mt-[20px] spotlight-section spotlight-section--tight spotlight-section--compact">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-6 h-[min(60vh,37.5rem)] spotlight-grid spotlight-grid--compact">
            <div id="spotlight-card-1" class="md:col-span-2 md:row-span-2 relative rounded-lg overflow-hidden group cursor-pointer bg-surface-container-low border border-outline-variant/10 spotlight-card" onclick="window.location.href='detail'">
              ...
              <img data-spotlight-rotating="1" alt="Spotlight de temporada" class="w-full h-full object-cover transition-transform duration-1000 ease-[cubic-bezier(0.2,0,0,1)] group-hover:scale-[1.04]" data-alt="Escena dramÃƒÆ’Ã‚Â¡tica de batalla anime con efectos de energÃƒÆ’Ã‚Â­a brillante" data-fallback="img/fondoanime.png" loading="lazy" referrerpolicy="no-referrer" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDfEs1IvGWNIZxiSWnnh8wCUr59ea4njuZckziZXqicnQPNvJkan5uFN_-BmFdNvpNSE7c6Gy-mHlJOyMU4hG1QNd2nk5WYUB4_uFh5jJL-K6arAlskDJ_8qihvbrLMvZNDOsSiBXcBUPHNcfenZNrmyKDhpAa0TRP_9gxyxTMIHLtWKcJBfTyyYK2OT7w8mggHKLEv6KE0h3MMHguW46V5ghR79auKbPcZFbiWP4qDRaPBSBDdTGBjWbacwEx2LnRwcBnZnp4l3j-4"/>
            ...
            <div id="spotlight-card-4" class="relative rounded-lg overflow-hidden group cursor-pointer bg-surface-container-low border border-outline-variant/10 spotlight-card" onclick="window.location.href='detail'">
              ...
              <div data-spotlight-type class="absolute top-4 left-4 z-10 bg-primary/80 text-white text-[11px] font-bold uppercase tracking-widest px-3 py-1 rounded-full shadow-lg">Anime</div>
              <img data-spotlight-rotating="1" alt="Spotlight de temporada" class="w-full h-full object-cover transition-transform duration-1000 ease-[cubic-bezier(0.2,0,0,1)] group-hover:scale-[1.04]" data-alt="Escena de acciÃƒÆ’Ã‚Â³n deportiva anime a ritmo frenÃƒÆ’Ã‚Â©tico" data-fallback="img/fondoanime.png" loading="lazy" referrerpolicy="no-referrer" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDJ5qAXtvlxTvCn09vDY4wAIFQ0pSixDM-EZ1_G2ikLShfPSIVgjE6BRxgPZEX_LsVn_WN_zHvw3ynIuf2qN3IVoT3ni8MkH0QMTcMI974YwQFJtcJeBMyvGHjDidzk9ppyNm3ysCA4gFA2aUBroWZ3GLFWIcpCLnxsJwGwJtIli6M5os4aZ5oTC_I4oEIhYCuZ55qZQomDSUFsexP297sinHqj50nQvCWlkqo4afO3JcqzF1tr5BSCvjidzOAnoBQUw-a_ATVuBrXKq"/>
              <div class="absolute inset-0 bg-black/40 group-hover:bg-primary-container/20 transition-colors flex flex-col justify-end p-4">
        ...
        <section class="px-8 md:px-16 mt-[30px]">
          ...
          <div class="carousel-wrap">
            ...
            <div class="carousel-card group cursor-pointer" onclick="window.location.href='detail'">
              <div class="relative aspect-[2/3] rounded-lg overflow-hidden bg-surface-container-high mb-4 transition-all duration-500 ease-[cubic-bezier(0.2,0,0,1)] group-hover:scale-[1.04] shadow-xl">
                <img alt="P&oacute;ster de anime" class="w-full h-full object-cover" data-alt="Ciudad anime detallada de noche con luces de neÃƒÆ’Ã‚Â³n" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWK6GEmMfgg6EfbuobMqKnAGEoBR-JDGiUg00ci-kmNlIZtDkYI6Kn2Ke0sXVPIgNQCXFd-IsHB0kiCe8S2Zky7Vx8s8Yv0q9tzs5HYMvwxzBr6cc0oZ2o_86dXwOsGkjr4PDjv3ULdj9hX4Eanz5BPS7V2PEEqNSKPjrv61ZaMxz7RmFHx1Ah01hoqVReWKva7mpYkiw9VwRTTlov4AGu-uJhSG3Bln2hIug_IIGpsqGQXkCpk6x8T2qTeXcy2R7y7otUdEHtPV9T"/>
                <div class="absolute inset-0 bg-primary-container/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                  <div class="flex flex-wrap gap-1 mb-2">
            ...
            <div class="carousel-card group cursor-pointer" onclick="window.location.href='detail'">
              <div class="relative aspect-[2/3] rounded-lg overflow-hidden bg-surface-container-high mb-4 transition-all duration-500 ease-[cubic-bezier(0.2,0,0,1)] group-hover:scale-[1.04] shadow-xl">
                <img alt="P&oacute;ster de anime" class="w-full h-full object-cover" data-alt="Silueta de espadachÃƒÆ’Ã‚Â­n anime contra una luna roja" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAR9x5iy6NpAOvezWnwzK2vesTKLBp29cvFNXUtwXht6dD1l_D5gxqns-j0rTWWHrKxrDe_gNz2hRv_bp72i7d3-B1XfbVcKL9UOdKUyxhkn7PVkTFK6gvR6FYot0OR1ZFv5kxq0aRiZ5uP-MPaYLYP3NbHMNLEF22YktmuRvb3820xC4ub0dVEhj3jZVy7-ZDMJBIgRaWhSUwsjWpaA_FPrQNkZspeF-urqaKWFj1HOZJbRz951KKRSdvfM9UeaS3zgtT822TzJSbT"/>
                <div class="absolute inset-0 bg-primary-container/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                  <div class="flex flex-wrap gap-1 mb-2">
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const localHeroOverrides = [
      { match: "attack on titan", src: ["https://cdn.myanimelist.net/images/anime/10/47347l.jpg"] },
      { match: "shingeki no kyojin", src: ["https://cdn.myanimelist.net/images/anime/10/47347l.jpg"] },
      { match: "snk", src: ["https://cdn.myanimelist.net/images/anime/10/47347l.jpg"] },
      { match: "death note", src: ["https://cdn.myanimelist.net/images/anime/9/9453l.jpg"] },
      { match: "fullmetal alchemist", src: ["https://cdn.myanimelist.net/images/anime/1208/94745l.jpg"] },
      { match: "fullmetal alchemist: brotherhood", src: ["https://cdn.myanimelist.net/images/anime/1223/96541l.jpg"] },
      { match: "one punch man", src: ["https://cdn.myanimelist.net/images/anime/12/76049l.jpg"] },
      { match: "demon slayer", src: ["https://cdn.myanimelist.net/images/anime/1286/99889l.jpg"] },
      { match: "kimetsu no yaiba", src: ["https://cdn.myanimelist.net/images/anime/1286/99889l.jpg"] },
      { match: "sword art online", src: ["https://cdn.myanimelist.net/images/anime/11/39717l.jpg"] }
    ];
    ...
    const heroSelections = [
      ...
      },
      {
        ...
        image: "img/jjk.webp",
        synopsis:
          "Tras las masacres de Shibuya, Itadori se aleja de la escuela mientras la cÃƒÆ’Ã‚Âºpula jujutsu reactiva su ejecuciÃƒÆ’Ã‚Â³n y pone a Yuta Okkotsu tras ÃƒÆ’Ã‚Â©l. Con el Juego de la ExterminaciÃƒÆ’Ã‚Â³n en marcha, hechiceros de distintas eras chocan y el destino de Fushiguro se vuelve el centro de la tormenta."
      },
    ...
    const updateGenreBadges = (media, genres, fallbackLabel) => {
      ...
      const translateGenre = (label) => {
        const map = {
          ...
          "Demons": "Demonios",
          "Samurai": "Samurai",
          "Police": "PolicÃƒÆ’Ã‚Â­a",
          "Super Power": "Superpoderes",
          "Harem": "Harem",
          "Reverse Harem": "Harem inverso",
          "Magical Girl": "Chica mÃƒÆ’Ã‚Â¡gica",
          "Kids": "Infantil",
          "Seinen": "Seinen",
          "Shounen": "Shounen",
          "Shoujo": "Shoujo",
