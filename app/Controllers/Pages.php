...
final class Pages extends BaseController
{
    ...
    public function show(string $slug): void
    {
        ...
        $viewName = is_file(APPPATH . 'Views/pages/' . $slug . '.php') ? 'pages/' . $slug : 'pages/404';
    ...
    private function pageMap(): array
    {
        return [
            ...
            'anadir' => [
                'title' => 'NekoraList - A̱adir Anime',
                'eyebrow' => 'Administracion',
                'heading' => 'A̱adir Anime',
                'description' => 'A̱ade animes manualmente o usando Jikan proxy.',
                'cards' => [],
            ],
            'gestion' => [
